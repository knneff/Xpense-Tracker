...
<?php require('views/group/partials/createJoin.php') ?>



<?php
/*
  <div class="scrollbar-custom overflow-auto py-24 flex flex-col sm:flex-row justify-center gap-10 h-full w-full bgGreen items-center">

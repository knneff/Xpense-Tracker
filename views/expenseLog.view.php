...
<div class='flex flex-col gap-5 sm:px-8 md:px-24 lg:px-48 xl:px-64'>
    ...
    <div class="h-20 w-20 border border-red-400 bg-red-50 "></div>
    <div class="h-20 w-20 border border-red-400 tlGreen "></div>
    ...
    if ($expenseSize < 1) {
        ...
        foreach ($expenses as $index => $expense) {
            ...
            echo "<div class='flex flex-row gap-5'>
                <!-- expenseCard -->
                <div id='$index' class='flex-1 textGray rounded-lg border border-gray-400'>
                    <!-- title (description, dateTime) -->
                    <div class='flex justify-between items-center rounded-t-lg bg-[#064E3B] px-4 py-2'>
                ...
                <!-- delete button -->
                <button id='$index'>
                    <svg class='text-[#bb3434] h-10 w-10' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='currentColor'>
                ...
                <main id='$delConfId' class='hidden'>
                    <div id='deleteOverlay' class='z-50 flex justify-center items-center fixed top-0 left-0 w-screen h-screen bg-black bg-opacity-50'>

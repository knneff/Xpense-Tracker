...
<div id="menu" class="dsm z-[47] h-full flex-shrink-0 tlGreen textGray flex-col border-r border-one border-gray-800
    ...
    <!-- AUDIT LOG -->
    <a href="/audit" title="Audit Log" class="hover:bg-emerald-900 transition flex flex-row items-center <?= isUri("/audit") ? 'bg-emerald-900' : '' ?>">
    ...
    <!-- Tickets -->
    <a href="/tickets" title="Tickets" class="hover:bg-emerald-900 transition flex flex-row items-center <?= isUri("/tickets") ? 'bg-emerald-900' : '' ?>">

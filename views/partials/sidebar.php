...
<div id="menu" class="fixed sm:relative dsm z-40 h-full flex-shrink-0 tlGreen textGray flex-col border-r border-one border-gray-800">
    ...
    <!-- HOME ICON -->
    <a href="/dashboard" title="Dashboard" class="hover:bg-emerald-900 flex flex-row items-center <?= isUri("/dashboard") ? 'bg-emerald-900' : '' ?>">
    ...
    <a href="/expenselog" title="Expense Log" class="hover:bg-emerald-900 flex flex-row items-center <?= isUri("/expenselog") ? 'bg-emerald-900' : '' ?>">
        <svg class="textGray w-12 p-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <!-- STATISTICS -->
    <a href="/statistics" title="Expense Log" class="hover:bg-emerald-900 flex flex-row items-center <?= isUri("/statistics") ? 'bg-emerald-900' : '' ?>">
        <svg class="textGray w-12 p-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <!-- GOAL -->
    <a href="/goal" title="Dashboard" class="hover:bg-emerald-900 flex flex-row items-center <?= isUri("/goal") ? 'bg-emerald-900' : '' ?>">
        <svg class="textGray w-12 p-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <!-- USER GROUPS ICON -->
    <a href="/shared" title="Expense Log" class="hover:bg-emerald-900 flex flex-row items-center <?= isUri("/shared") ? 'bg-emerald-900' : '' ?>">
        <svg class="textGray w-12 p-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <a href="/signup" title="Expense Log" class="hover:bg-emerald-900 flex flex-row items-center">
        <svg class="textGray w-12 p-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <!-- AUDIT LOG -->
    <a href="/audit" title="Expense Log" class="hover:bg-emerald-900 flex flex-row items-center <?= isUri("/audit") ? 'bg-emerald-900' : '' ?>">
    ...
    <!-- SYSTEM SETTINGS -->
    <a href="/settings" title="System Settings" class="hover:bg-emerald-900 flex flex-row items-center <?= isUri("/settings") ? 'bg-emerald-900' : '' ?>">
        <svg class="textGray w-12 p-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <svg class="textGray hover:bg-emerald-900 p-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">

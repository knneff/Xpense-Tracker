...
<div id="menu" class="sticky sm:relative dsm z-40 h-full flex-shrink-0 tlGreen textGray flex-col border-r border-one border-gray-800">
    ...
    <!-- USER GROUPS ICON -->
    <a href="/group" title="Shared Expense" class="hover:bg-emerald-900 transition flex flex-row items-center <?= isUri("/shared") ? 'bg-emerald-900' : '' ?>">
        <svg class="textGray w-12 p-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">

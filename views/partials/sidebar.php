...
<div id="menu" class="dsm z-[47] h-full flex-shrink-0 tlGreen textGray flex-col border-r border-one border-gray-800
    ...
    <!-- HOME / DASHBOARD ICON -->
    <a href="/dashboard" title="Dashboard" class="hover:bg-emerald-900 transition flex flex-row items-center <?= isUri("/dashboard") ? 'bg-emerald-900' : '' ?>">
    ...
    <a href="/expenselog" title="Expense Log" class="hover:bg-emerald-900 transition flex flex-row items-center <?= isUri("/expenselog") ? 'bg-emerald-900' : '' ?>">

        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="textGray size-12 p-3">
    ...
    <!-- STATISTICS -->
    <a href="/statistics" title="Statistics" class="hover:bg-emerald-900 transition flex flex-row items-center <?= isUri("/statistics") ? 'bg-emerald-900' : '' ?>">
        <svg class="textGray w-12 p-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <!-- GOAL -->
    <a href="/goal" title="Goals and Plans" class="hover:bg-emerald-900 transition flex flex-row items-center <?= isUri("/goal") ? 'bg-emerald-900' : '' ?>">
        <svg class="textGray w-12 p-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <!-- SHARED/GROUP ICON -->
    <a href="/group" title="Shared Expense" class="hover:bg-emerald-900 transition flex flex-row items-center <?= isUri("/group") ? 'bg-emerald-900' : '' ?>">
        <svg class="textGray w-12 p-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <!-- SUBSCRIPTION LIST -->
    <a href="/subscriptions" title="Subscription" class="hover:bg-emerald-900 transition flex flex-row items-center <?= isUri("/subscriptions") ? 'bg-emerald-900' : '' ?>">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="textGray w-12 p-3">
            <path d="M12 7.5a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5Z" />
            <path fill-rule="evenodd" d="M1.5 4.875C1.5 3.839 2.34 3 3.375 3h17.25c1.035 0 1.875.84 1.875 1.875v9.75c0 1.036-.84 1.875-1.875 1.875H3.375A1.875 1.875 0 0 1 1.5 14.625v-9.75ZM8.25 9.75a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0ZM18.75 9a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75V9.75a.75.75 0 0 0-.75-.75h-.008ZM4.5 9.75A.75.75 0 0 1 5.25 9h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75H5.25a.75.75 0 0 1-.75-.75V9.75Z" clip-rule="evenodd" />
            <path d="M2.25 18a.75.75 0 0 0 0 1.5c5.4 0 10.63.722 15.6 2.075 1.19.324 2.4-.558 2.4-1.82V18.75a.75.75 0 0 0-.75-.75H2.25Z" />
        </svg>
        <label class="btn_label dsl textGray flex-grow">Subscriptions</label>
    </a>

    <!-- AUDIT LOG -->
    <a href="/audit" title="Audit Log" class="<?= ($_SESSION['userid'] == 4 || $_SESSION['userid'] == 25) ? 'flex' : 'hidden' ?> hover:bg-emerald-900 transition flex flex-row items-center <?= isUri("/audit") ? 'bg-emerald-900' : '' ?>">
    ...
    <!-- Tickets -->
    <a href="/tickets" title="Tickets" class="<?= ($_SESSION['userid'] == 4 || $_SESSION['userid'] == 25) ? 'flex' : 'hidden' ?> hover:bg-emerald-900 transition flex flex-row items-center <?= isUri("/tickets") ? 'bg-emerald-900' : '' ?>">

        <svg class="size-12 p-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="SVGRepo_iconCarrier">
                <path d="M10 9H17M10 13H17M7 9H7.01M7 13H7.01M21 20L17.6757 18.3378C17.4237 18.2118 17.2977 18.1488 17.1656 18.1044C17.0484 18.065 16.9277 18.0365 16.8052 18.0193C16.6672 18 16.5263 18 16.2446 18H6.2C5.07989 18 4.51984 18 4.09202 17.782C3.71569 17.5903 3.40973 17.2843 3.21799 16.908C3 16.4802 3 15.9201 3 14.8V7.2C3 6.07989 3 5.51984 3.21799 5.09202C3.40973 4.71569 3.71569 4.40973 4.09202 4.21799C4.51984 4 5.0799 4 6.2 4H17.8C18.9201 4 19.4802 4 19.908 4.21799C20.2843 4.40973 20.5903 4.71569 20.782 5.09202C21 5.51984 21 6.0799 21 7.2V20Z" stroke="#d1d5db" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </g>

        </svg>


        <label class="btn_label dsl textGray flex-grow">Tickets</label>
    </a>

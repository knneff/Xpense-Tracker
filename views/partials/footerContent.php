        ...
        <div class="grid grid-cols-1 gap-10 lg:grid-cols-3">
            <div>
                ...
                <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                    <li>
                        <a href="https://www.facebook.com/xpense.tracker.mail" rel="noreferrer" target="_blank" class="text-teal-700 transition hover:text-teal-700/75 dark:text-teal-500 dark:hover:text-teal-500/75">
            ...
            <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-4 lg:ml-20 lg:col-span-2">
                ...
                <div class="text-center sm:text-left">
                    ...
                    <ul class="mt-8 space-y-4 text-sm">
                        <li>
                            <a class="flex items-center gap-1.5 sm:justify-start" href="mailto:Xpense@track.com">
                        ...
                        <li>
                            <a class="flex items-center justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end" href="tel:+0123456789">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5 shrink-0 text-gray-900 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                <span class="flex-1 text-gray-700 dark:text-gray-300">0926 657 9870</span>
                            </a>
                        </li>

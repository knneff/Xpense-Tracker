<section id="createJoinGroupPanel" class="hidden fixed  inset-0 bg-black bg-opacity-50 transition-opacity">
    <container class='flex justify-center h-full items-center'>

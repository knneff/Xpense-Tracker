...
<!-- Mission and Values -->
<header class="bg-emerald-900 text-white text-center py-16 relative rounded-lg">
    <h1 class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-shadow-lg leading-tight">
        About Us
    </h1>
    <p class="mt-4 text-base sm:text-lg font-semibold max-w-2xl mx-auto text-gray-200 leading-relaxed">
...
<section class="py-12 bgGreen text-white">
    ...
    <p class="mt-4 text-lg text-center text-gray-200">
    ...
    <section class="py-12 text-center">
        <div class="max-w-5xl mx-auto">
            <h3 class="text-3xl font-bold text-gray-200 mb-6">Team Leader</h3>
            <div class="flex justify-center">
                <!-- Team Leader Profile -->
                <div class="text-center transform transition-transform duration-300 hover:scale-105">
                    <img class="w-60 h-60 mx-auto rounded-full border-4 border-green-800 object-cover shadow-lg hover:shadow-xl transition-shadow duration-300" src="team-leader1.jpg" alt="Skibidi">
                    <h3 class="mt-4 text-2xl font-bold text-green-400">Skibidi</h3>
                    <p class="mt-2 text-gray-400 text-lg">CEO & Founder</p>
    ...
    <div class="mt-12 text-center">
        <h3 class="text-3xl font-bold text-gray-200 mb-10">Team Managers</h3>
    ...
    <!-- Front-end & Back-end Developers Section -->
    <div class="mt-12 text-center">
        <h3 class="text-3xl font-bold text-gray-200 mb-10">Front-end & Back-end Developers</h3>
        <div class="flex justify-center gap-16 flex-wrap">
            <!-- Developer 1 -->
            <div class="text-center m-0 transform transition-transform duration-300 hover:scale-105">
                <img class="w-40 h-40 mx-auto rounded-full border-4 border-green-800 object-cover shadow-lg hover:shadow-xl transition-shadow duration-300" src="team-member5.jpg" alt="Stuart">
                <h3 class="mt-4 text-xl font-bold text-green-400">Stuart</h3>
                <p class="mt-2 text-gray-400 text-lg">UI</p>
                <div class="mt-4 flex justify-center flex-col space-y-2">
                    <!-- Email -->
                    <div class="flex items-center justify-center space-x-2">
            ...
            <!-- Developer 2 -->
            <div class="text-center m-0 transform transition-transform duration-300 hover:scale-105">
                <img class="w-40 h-40 mx-auto rounded-full border-4 border-green-800 object-cover shadow-lg hover:shadow-xl transition-shadow duration-300" src="team-member6.jpg" alt="Benny">
                <h3 class="mt-4 text-xl font-bold text-green-400">Benny</h3>
                <p class="mt-2 text-gray-400 text-lg">UI</p>
                <div class="mt-4 flex justify-center flex-col space-y-2">
                    <!-- Email -->
                    <div class="flex items-center justify-center space-x-2">
            ...
            <!-- Developer 3 -->
            <div class="text-center m-0 transform transition-transform duration-300 hover:scale-105">
                <img class="w-40 h-40 mx-auto rounded-full border-4 border-green-800 object-cover shadow-lg hover:shadow-xl transition-shadow duration-300" src="team-member7.jpg" alt="Luna">
                <h3 class="mt-4 text-xl font-bold text-green-400">Luna</h3>
                <p class="mt-2 text-gray-400 text-lg">UI</p>
                <div class="mt-4 flex justify-center flex-col space-y-2">
                    <!-- Email -->
                    <div class="flex items-center justify-center space-x-2">
        ...
        <!-- Row 2: Developer 4, Developer 5, Developer 6 -->
        <div class="flex justify-center gap-16 mt-8 flex-wrap">
            <!-- Developer 4 -->
            <div class="text-center m-0 transform transition-transform duration-300 hover:scale-105">
                <img class="w-40 h-40 mx-auto rounded-full border-4 border-green-800 object-cover shadow-lg hover:shadow-xl transition-shadow duration-300" src="team-member8.jpg" alt="Max">
                <h3 class="mt-4 text-xl font-bold text-green-400">Max</h3>
                <p class="mt-2 text-gray-400 text-lg">UI</p>
                <div class="mt-4 flex justify-center flex-col space-y-2">
                    <!-- Email -->
                    <div class="flex items-center justify-center space-x-2">
            ...
            <!-- Developer 5 -->
            <div class="text-center m-0 transform transition-transform duration-300 hover:scale-105">
                <img class="w-40 h-40 mx-auto rounded-full border-4 border-green-800 object-cover shadow-lg hover:shadow-xl transition-shadow duration-300" src="team-member9.jpg" alt="Luca">
                <h3 class="mt-4 text-xl font-bold text-green-400">Luca</h3>
                <p class="mt-2 text-gray-400 text-lg">UI</p>
                <div class="mt-4 flex justify-center flex-col space-y-2">
                    <!-- Email -->
                    <div class="flex items-center justify-center space-x-2">
            ...
            <!-- Developer 6 -->
            <div class="text-center m-0 transform transition-transform duration-300 hover:scale-105">
                <img class="w-40 h-40 mx-auto rounded-full border-4 border-green-800 object-cover shadow-lg hover:shadow-xl transition-shadow duration-300" src="team-member10.jpg" alt="Kimberly">
                <h3 class="mt-4 text-xl font-bold text-green-400">Kimberly</h3>
                <p class="mt-2 text-gray-400 text-lg">UI</p>
                <div class="mt-4 flex justify-center flex-col space-y-2">
                    <!-- Email -->
                    <div class="flex items-center justify-center space-x-2">
